...
void configure_leds(void) {
  ...
  ESP_ERROR_CHECK(led_set_state(POWER_LED_GPIO, 0));
  ESP_ERROR_CHECK(led_set_state(DMX_OUT_LED_GPIO, 0));
  ESP_ERROR_CHECK(led_set_state(DMX_IN_LED_GPIO, 0));
  ESP_ERROR_CHECK(led_set_state(ARTNET_IN_LED_GPIO, 0));
  ESP_ERROR_CHECK(led_set_state(AP_MODE_LED_GPIO, 0));
  ESP_ERROR_CHECK(led_set_state(CLIENT_MODE_LED_GPIO, 0));
